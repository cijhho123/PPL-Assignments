...
import { CExp, Exp, IfExp, LetrecExp, LetExp, ProcExp, PredProcExp, Program, SetExp, isCExp } from './L5-ast';
...
import { isAppExp, isDefineExp, isIfExp, isLetrecExp, isLetExp,
         isProcExp,isPredProcExp, isSetExp } from "./L5-ast";
...
export const applicativeEval = (exp: CExp, env: Env): Result<Value> =>
    ...
    isPredProcExp(exp) ? evalPredProc(exp, env):    //addition
...
const evalPredProc = (exp: PredProcExp, env: Env): Result<Closure> =>
    makeOk(makeClosure([exp.arg], exp.body, env))
